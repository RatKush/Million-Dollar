...
def toggle_input_visibility_kdes(kde_flags, active_tab):
    return [
        {"display": "block"} if "val_line" in kde_flags else {"display": "none"},
        {"display": "block"} if "pc_line" in kde_flags else {"display": "none"},
        {"display": "block"} if any(f in kde_flags for f in ["local_mean", "local_xn", "local_bb"]) else {"display": "none"}
    ]
