...
footer_component = html.Footer([
    html.Div([
        ...
        html.Div([
            ...
            dcc.Textarea(
                id="feedback-text",
                placeholder="Write your feedback here.....(kindly provide all parameters when error occured)",
                style={
...
############################################   # Links Section################################################
    html.Div([
        html.Div([
            ...
            # html.A("structures list", href="https://github.com/RatKush/Million-Dollar/blob/master/structures%20list.txt", target="_blank",
            #        style={"color": "#c0c4cc", "marginRight": "10px"}),
            html.Div([
                html.A("Structures List",id="structures-link",href="https://github.com/RatKush/Million-Dollar/blob/main/assets/structures_list.txt",style={"textDecoration": "underline"},target="_blank",className="hover-link"),
                html.Div(html.Pre(open("assets/structures_list.txt", encoding="utf-8").read()[:3000]),className="hover-card"
        ...
        html.Div([
            ...
            html.A("EFFR daily fixing", href="https://www.newyorkfed.org/markets/reference-rates/effr", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("EFFR cycle", href="https://fred.stlouisfed.org/series/FEDFUNDS", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("ECB cycle", href="https://fred.stlouisfed.org/series/ECBDFR", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),     
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("BOE cycle", href="https://www.bankofengland.co.uk/boeapps/database/Bank-Rate.asp", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("BoC cycle", href="https://www.bankofcanada.ca/core-functions/monetary-policy/key-interest-rate/", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("SNB cycle", href="https://data.snb.ch/en/topics/snb/cube/snboffzisa?view=chart", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
            html.A("BoB cycle", href="https://www.bcb.gov.br/en/statistics", target="_blank",
                   style={"color": "#c0c4cc", "marginRight": "12px"}),
            html.Span("|", style={"color": "#888888", "marginRight": "12px"}),
