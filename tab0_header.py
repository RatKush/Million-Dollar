...
COMMODITY_GROUPS = {
    ...
    "SR3-ER3": {"sr3 er3", "sr3 vs er3", "sr3-er3", "sr3 vs er3", "sr3 er3", "sr3 vs er3", "sr3-er3", "sr3 vs er3"},
    "ER-SO3":  {"er so3", "er vs so3", "er-so3", "er vs so3", "er so3", "er vs so3", "er-so3", "er vs so3"},
    "ER3-SO3":  {"er3 so3", "er3 vs so3", "er3-so3", "er3 vs so3", "er3 so3", "er3 vs so3", "er3-so3", "er3 vs so3"},
